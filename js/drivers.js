...
(async function () {
    ...
    function ensureDriversAnalyticsSection() {
        ...
        section.innerHTML = '<div class="section-header"><h2>Standings Snapshot</h2></div><div id="drivers-analytics-grid" class="standings-analytics-grid"></div>';

        const tableEl = document.getElementById('drivers-table');
        const gridEl = document.getElementById('drivers-grid');
        if (tableEl) {
            tableEl.insertAdjacentElement('afterend', section);
        } else if (gridEl) {
            gridEl.insertAdjacentElement('afterend', section);
        }
        return section;
    }
    ...
    function ensureDriversCompareSection() {
        ...
        section.innerHTML = `
            <div class="section-header"><h2>Driver Compare</h2></div>
    ...
    function ensureDriversFormSection() {
        ...
        section.innerHTML = '<div class="section-header"><h2>Recent Driver Form</h2></div><div id="drivers-form-grid" class="drivers-form-grid"></div>';
