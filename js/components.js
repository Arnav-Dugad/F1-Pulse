...
// Official 2026 team car images sourced from team media endpoints
...
// --- Circuit Image System (custom layout map + API fallback) ---
const _circuitImageCache = {};

// Paste official track layout URLs here to override circuit layouts globally.
// Key format: normalized circuit id/name (letters+numbers only, lowercase).
const CUSTOM_CIRCUIT_LAYOUTS = {
    albertparkcircuit: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackmelbournedetailed.webp',
    shanghaiinternationalcircuit: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackshanghaidetailed.webp',
    suzukainternationalracingcourse: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026tracksuzukadetailed.webp',
    miamiinternationalautodrome: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackmiamidetailed.webp',
    circuitgillesvilleneuve: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackmontrealdetailed.webp',
    circuitdemonaco: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackmontecarlodetailed.webp',
    circuitdebarcelonacatalunya: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackcatalunyadetailed.webp',
    ...
    silverstonecircuit: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026tracksilverstonedetailed.webp',
    circuitdespafrancorchamps: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackspafrancorchampsdetailed.webp',
    hungaroring: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackhungaroringdetailed.webp',
    circuitzandvoort: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackzandvoortdetailed.webp',
    monzacircuit: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackmonzadetailed.webp',
    autodromonazionaledimonza: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackmonzadetailed.webp',
    madring: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackmadringdetailed.webp',
    bakucitycircuit: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackbakudetailed.webp',
    marinabaystreetcircuit: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026tracksingaporedetailed.webp',
    circuitoftheamericas: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackaustindetailed.webp',
    autodromohermanosrodriguez: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackmexicocitydetailed.webp',
    interlagoscircuit: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackinterlagosdetailed.webp',
    autodromojosecarlospace: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackinterlagosdetailed.webp',
    lasvegasgrandprix: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026tracklasvegasdetailed.webp',
    lasvegasstripcircuit: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026tracklasvegasdetailed.webp',
    lasvegasstripstreetcircuit: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026tracklasvegasdetailed.webp',
    lusailinternationalcircuit: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026tracklusaildetailed.webp',
    losailinternationalcircuit: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026tracklusaildetailed.webp',
    yasmarinacircuit: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026trackyasmarinacircuitdetailed.webp',
    bahraininternationalcircuit: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/common/f1/2026/track/2026tracksakhirdetailed.webp',
    jeddahcornichecircuit: 'https://media.formula1.com/image/upload/c_fit,h_704/q_auto/v1740000001/content/dam/fom-website/2018-redesign-assets/Circuit%20maps%2016x9/Saudi_Arabia_Circuit.webp',
};
...
function getCircuitLayoutFromConfig(circuitUrl, circuitName) {
    const keys = [];
    ...
    for (const rawKey of keys) {
        ...
        for (const k of candidates) {
            const custom = CUSTOM_CIRCUIT_LAYOUTS[k];
            if (custom) return custom;
            const fuzzyCustom = Object.keys(CUSTOM_CIRCUIT_LAYOUTS).find(mapKey => k.includes(mapKey) || mapKey.includes(k));
            if (fuzzyCustom) return CUSTOM_CIRCUIT_LAYOUTS[fuzzyCustom];
        }
    }
    return null;
}
...
async function fetchCircuitImage(circuitUrl, circuitName = '') {
    ...
    const listedLayout = getCircuitLayoutFromConfig(circuitUrl, circuitName);
    if (listedLayout) {
...
function getCircuitImageUrl(circuitUrl, circuitName = '') {
    ...
    return getCircuitLayoutFromConfig(circuitUrl, circuitName);
}
...
const UI_ICONS = {
    ...
    back: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6"></path><path d="M21 12H9"></path></svg>',
    ...
    about: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"></circle><path d="M12 10v6"></path><circle cx="12" cy="7" r="1"></circle></svg>',
    ...
    f1tv: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2.5" y="5" width="19" height="14" rx="2"></rect><path d="M10 9l6 3-6 3z"></path></svg>',
...
// Add your custom logo URL here (or set window.F1TV_BUTTON_CONFIG before initPage runs).
const F1TV_BUTTON_CONFIG = {
    href: 'https://f1tv.formula1.com/',
    logoImageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYt8EM8uBxrBMsLyz0pAvxIrAtFirj4WaVoQ&s',
    logoAlt: 'F1 TV',
    logoText: 'F1 TV',
    buttonText: 'Watch Live',
};

function getF1TVButtonConfig() {
    const external = (window.F1TV_BUTTON_CONFIG && typeof window.F1TV_BUTTON_CONFIG === 'object')
        ? window.F1TV_BUTTON_CONFIG
        : {};
    return {
        ...F1TV_BUTTON_CONFIG,
        ...external,
...
function buildNav(activePage) {
    const f1tvConfig = getF1TVButtonConfig();
    const f1tvHref = String(f1tvConfig.href || 'https://f1tv.formula1.com/');
    const f1tvHasLogoImage = !!String(f1tvConfig.logoImageUrl || '').trim();
    const f1tvLogo = f1tvHasLogoImage
        ? `<img src="${f1tvConfig.logoImageUrl}" alt="${f1tvConfig.logoAlt || 'F1 TV'}" class="nav-f1tv-logo-img" loading="lazy" decoding="async" onerror="this.style.display='none';this.nextElementSibling.style.display='inline-flex'">`
        : '';
    const f1tvFallbackText = `<span class="nav-f1tv-logo" style="display:${f1tvHasLogoImage ? 'none' : 'inline-flex'}">${f1tvConfig.logoText || 'F1 TV'}</span>`;
    ...
    const pages = [
        ...
        { id: 'about', label: 'About', href: 'about.html', icon: UI_ICONS.about },
    ];
    ...
    nav.innerHTML = `
        <div class="nav-container">
            ...
            <a href="${f1tvHref}" class="nav-f1tv-btn" target="_blank" rel="noopener noreferrer" aria-label="Open F1 TV">
                ${f1tvLogo}
                ${f1tvFallbackText}
                <span class="nav-f1tv-text">${f1tvConfig.buttonText || 'Watch Live'}</span>
                ${iconHTML(UI_ICONS.f1tv, 'nav-f1tv-icon')}
            </a>
...
function resolveBackFallbackURL(activePage) {
    const file = (window.location.pathname.split('/').pop() || '').toLowerCase();
    if (file === 'driver-profile.html' || file === 'team-profile.html') return 'about.html';
    if (file === 'race-detail.html') return 'schedule.html';
    if (file === 'about.html') return 'index.html';
    if (activePage === 'drivers' || activePage === 'teams' || activePage === 'schedule' || activePage === 'race') return 'index.html';
    return 'index.html';
}

function createPageBackButton(activePage) {
    if (activePage === 'home') return;
    if (document.getElementById('global-page-back-wrap')) return;

    const pageContent = document.querySelector('.page-content');
    let mainContainer = null;
    if (pageContent) {
        try {
            mainContainer = pageContent.querySelector(':scope > .container:last-of-type');
        } catch (e) {
            mainContainer = null;
        }
    }
    mainContainer = mainContainer || document.querySelector('.page-content .container');
    if (!mainContainer) return;

    const wrap = document.createElement('div');
    wrap.id = 'global-page-back-wrap';
    wrap.className = 'page-back-row';
    wrap.innerHTML = `
        <button type="button" id="global-page-back-btn" class="page-back-btn" aria-label="Go back to previous page">
            ${iconHTML(UI_ICONS.back, 'page-back-icon')}
            <span>Back</span>
        </button>`;

    mainContainer.insertAdjacentElement('afterbegin', wrap);

    const btn = document.getElementById('global-page-back-btn');
    btn?.addEventListener('click', () => {
        const fallbackUrl = resolveBackFallbackURL(activePage);
        const currentFile = (window.location.pathname.split('/').pop() || '').toLowerCase();

        // Keep About deterministic so the button always returns to Home from this hub page.
        ...
        if (referrer) {
            try {
                ...
                if (sameOrigin && refFile && refFile !== currentFile) {
                    window.history.back();
                    return;
                }
            } catch (e) {
                // Fall through to deterministic fallback routing.
            }
        }
...
function createQuickActionsDock(activePage) {
    ...
    dock.innerHTML = `
        ...
        <div id="quick-actions-panel" class="quick-actions-panel" aria-hidden="true">
            ...
            <div class="quick-actions-links">
                ...
                <a href="about.html" class="quick-actions-link ${activePage === 'about' ? 'active' : ''}">About (A)</a>
    ...
    if (!window.__f1QuickActionsBound) {
        ...
        document.addEventListener('keydown', (e) => {
            ...
            if (key === 'a') window.location.href = 'about.html';
            if (key === 'n') {
...
function createFloatingStandingsWidget(activePage) {
    ...
    function renderRows() {
        ...
        if (state.mode === 'drivers') {
            ...
            if (!rows.length) {
                body.innerHTML = '<div class="quick-actions-empty">No driver ranking data available.</div>';
                return;
            }
        ...
        const rows = state.constructorStandings || [];

        if (!rows.length) {
            body.innerHTML = '<div class="quick-actions-empty">No team ranking data available.</div>';
            return;
        }
...
async function openDriverModal(driverId, constructorId, season) {
    ...
    try {
        ...
        const ed = await loadEnrichedDrivers().catch(() => ({}));
...
function initPage(activePage) {
    ...
    try { localStorage.removeItem('f1pulse_recent_races_v1'); } catch (e) { /* ignore */ }
    buildNav(activePage);
    createDriverBulletinStrip();
    buildFooter();
    injectGlobalPageVisualLayer(activePage);
    createPageBackButton(activePage);
