...
Fall to fourth overall despite two wins apiece for George Russell and Lewis Hamilton in the rather inconsistent W15. Season starts with shock announcement that Hamilton is to depart for Ferrari at the end of the year.`,
        ferrari: 'Ferrari pairs historic racing heritage with aggressive development cycles, often focusing on sharp front-end performance and qualifying speed.',
        mclaren: 'McLaren emphasizes modern aerodynamic efficiency and balanced race pace, making it one of the most consistently competitive outfits.',
        red_bull: 'Red Bull Racing is built around high-downforce confidence, decisive strategy calls, and relentless race execution under pressure.',
        aston_martin: 'Aston Martin continues expanding its technical platform with a focus on operational precision and continuous in-season gains.',
        alpine: 'Alpine targets agile chassis behavior and strategic flexibility, aiming to maximize opportunities across varied circuit characteristics.',
        williams: 'Williams blends legacy with renewed performance ambition, often optimizing straight-line speed and race-day adaptability.',
        rb: 'Racing Bulls serves as a high-performance development platform with sharp operational tempo and aggressive weekend execution.',
        haas: 'Haas focuses on efficient execution and setup tuning, often unlocking strong race outcomes through disciplined strategy.',
        audi: 'Audi enters with long-term factory ambition, prioritizing integrated development between power unit, aero package, and race operations.',
        cadillac: 'Cadillac represents a major U.S. works effort, combining brand momentum with a growth-focused technical and competitive roadmap.',
    };
    ...
    const TEAM_DETAILS = {
        ...
        aston_martin: {
            ...
            chassis: 'AMR26',
            powerUnit: 'Mercedes',
            reserveDriver: 'Felipe Drugovich',
            firstTeamEntry: '2021',
        },
        alpine: {
        ...
        haas: {
            ...
            chassis: 'VF-26',
            powerUnit: 'Ferrari',
            reserveDriver: 'Pietro Fittipaldi',
            firstTeamEntry: '2016',
        },
        audi: {
            fullTeamName: 'Audi Formula 1 Team',
            base: 'Hinwil, Switzerland',
            teamChief: 'Jonathan Wheatley',
            technicalChief: 'Mattia Binotto',
            chassis: 'A26',
            powerUnit: 'Audi',
            reserveDriver: 'Theo Pourchaire',
            firstTeamEntry: '2026',
        },
        cadillac: {
